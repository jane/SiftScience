...
namespace SiftScience
{
    public interface ISiftScienceClient
    {
        ...
        Task<ResponseStatus> Login(Login login, dynamic customFields = null, ReturnType returnType = ReturnType.None);
    ...
    public class SiftScienceClient : ISiftScienceClient
    {
        ...
        public async Task<ResponseStatus> Login(Login login, dynamic customFields = null, ReturnType returnType = ReturnType.None)
        {
            JObject json = GetJsonObject(login);
            json.Add("$api_key", _apiKey);
            json.Add("$type", "$login");
        ...
        private async Task<ResponseStatus> PostEvent(string jsonContent, ReturnType returnType)
        {
            ...
            switch (returnType)
            {
                ...
                case ReturnType.Score:
                    ...
                    break;
                case ReturnType.AccountTakeoverWorkflow:
                    endpoint = Globals.EventsWithAccountTakeoverWorkflowEndpoint;
                    break;
                case ReturnType.PaymentAbuseWorkflow:
                    endpoint = Globals.EventsWithPaymentAbuseWorkflowEndpoint;
                    break;
                default:
